...
Game.getInitialProps = async ({ req , res , match , history , location , ...ctx })=>{
    const search = ctx?.query?.query ?? "";
    const response = await fetch(`http://www.omdbapi.com/?apikey=42b5a54d&s=${search}&type=game`);
...
var __webpack_exports__ = __webpack_require__.X(0, [782], () => (__webpack_exec__(4888)));
